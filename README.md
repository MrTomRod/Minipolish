...
```
usage: minipolish [-t THREADS] [--rounds ROUNDS] [--minimap2-preset {map-pb,map-ont,map-hifi}] [-h] [--version] reads assembly
...
Settings:
  ...
  --minimap2-preset {map-pb,map-ont,map-hifi}
                                 Specify the minimap2 preset to use: "map-pb" for PacBio CLR,
